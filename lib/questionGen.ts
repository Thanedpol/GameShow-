...
⚠️ โจทย์ต้องคิดหลายชั้น (ผู้เล่นบอกว่าของเดิมง่ายเกินไป):
...
const STAGE_BRIEF: Record<Stage, string> = {
  warmup: [
    "ช่วงวอร์มอัพ — ต้องคิด 2 ชั้น ไม่ใช่ตอบได้ทันที แต่ยังไม่ต้องกดดัน",
    "ตัวลวงเป็นความเข้าใจผิดที่พบบ่อยจริง ๆ · ถ้ามีคำนวณ ให้เป็นขั้นตอนเดียวจบ",
    "ระดับ: กลาง (ห้ามใส่ข้อที่อ่านแล้วตอบได้ทันทีโดยไม่ต้องคิด)",
  ].join("\n  "),
  push: [
